    ...
    public void callNumber(String numero){
        ...
        else
        {
            ...
            if (ActivityCompat.checkSelfPermission(context.getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ...
                //ohhh you need to get permission//use Ted permission library...its very easy to use for runtime permissions
                // is that cause the erroe ?
                // runtime permission
                //    implementation 'gun0912.ted:tedpermission:2.2.3'
               // you check it and i take dinner
                return;
            }
